...
* sidestep additional transitive dependencies.  Node's built-in `http`
* module is perfectly adequate for the simple JSON POST that our tests run.
*/
